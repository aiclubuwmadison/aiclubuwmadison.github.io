    ...
    return (
        <>
            ...
            <Container className="about-page">
                ...
                <BodyText>AI@UW is the largest Artificial Intelligence club at UW-Madison. We aim to build a community of students from all backgrounds united by a shared interest in AI. Starting as just 7 undergrads in 2017 by Chris Endermann, we have since expanded our reach to over 2000 undergrads, graduate students, and faculty. We pride ourselves on our interdisciplinary approach to learning and building - people of all backgrounds and academic interests have a place in our organization.</BodyText>
