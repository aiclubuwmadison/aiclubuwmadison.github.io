...
import { Typography, Collapse, Container, Grid, Card, CardContent, Button, Chip } from '@material-ui/core';
        ...
        <>
            <section className="page-hero gradient-bg">
                ...
                <Container className="page-hero-content">
                    <Typography variant="h3" className="home-hero-title">Study Groups</Typography>
                    <Typography variant="body1" className="home-hero-subtitle">Structured learning paths led by peers—ML, DL, NLP, CV, RL, and MLOps.</Typography>
                </Container>
            </section>

            <Container className="page-section">
                <Typography variant="h4" className="home-section-title">Tracks</Typography>
                <Grid container spacing={3}>
                    {/*
                        { t: 'ML Fundamentals', chips: ['Linear Models', 'Trees', 'Pipelines'] },
                        { t: 'Deep Learning', chips: ['PyTorch', 'CNNs', 'Transformers'] },
                        { t: 'NLP & LLMs', chips: ['Tokenization', 'Fine-tuning', 'RAG'] },
                        { t: 'Computer Vision', chips: ['Detection', 'Segmentation', 'Augmentation'] },
                        { t: 'Reinforcement Learning', chips: ['Gymnasium', 'Policy Gradients', 'SB3'] },
                        { t: 'MLOps', chips: ['DVC', 'W&B', 'Serving'] },
                    */}
                    { [
                        { t: 'ML Fundamentals', chips: ['Linear Models', 'Trees', 'Pipelines'] },
                        { t: 'Deep Learning', chips: ['PyTorch', 'CNNs', 'Transformers'] },
                        ...
                        <Grid item xs={12} sm={6} md={4} key={f.t}>
                            <Card className="home-card">
                                <CardContent>
                                    <Typography variant="h6" className="home-card-title">{f.t}</Typography>
                                    <div style={{ marginTop: 6 }}>
                                        {f.chips.map(k => (
                                            <Chip key={k} label={k} size="small" className="home-chip" style={{ marginRight: 6, marginBottom: 6 }} />
                                        ))}
                                    </div>
                                    <Button size="small" color="primary" style={{ marginTop: 8 }}>Join</Button>
                                </CardContent>
                            </Card>
                        </Grid>
                    ))}
