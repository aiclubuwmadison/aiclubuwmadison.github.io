...
import { Container, Typography, Grid, Card, CardContent, Chip } from '@material-ui/core';
		...
		<>
			...
			<Container className="page-section">
				...
				<Grid container spacing={3}>
					{sorted.map((s) => (
						<Grid item xs={12} md={6} key={`${s.title}-${s.date}`}>
			...
			{/* Workshops / Tutorials section */}
			<Container className="page-section">
				<Typography variant="h4" className="home-section-title">Workshops / Tutorials</Typography>
				<Typography variant="subtitle1" className="domain-text" style={{ marginBottom: 12 }}>Past Workshops/Tutorials</Typography>
				<Grid container spacing={3}>
					{workshops.map((w) => (
						<Grid item xs={12} md={6} key={w.title}>
