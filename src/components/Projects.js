...
const Projects = () => {
    ...
    return (
        <Container>
            ...
            <BodyText>
            Project Groups have temporarily been paused while feedback is being gathered and student's preferences are being heard. Pending their resumption, this website will be 
            updated with the new information. For now, the Spring 2019 project groups remain below for your reference.
            </BodyText>
            {/* <Header>
                Projects
            </Header> */}
