        ...
        <>
            <section className="page-hero gradient-bg">
                ...
                <Container className="page-hero-content">
                    <Typography variant="h3" className="home-hero-title">FAQ</Typography>
                    <Typography variant="body1" className="home-hero-subtitle">Everything you need to know about joining and thriving at AI@UW.</Typography>
                </Container>
            </section>
            ...
            <Container className="page-section">
                <Grid container spacing={3}>
                    {/*
                        { q: 'Do I need prior AI/ML experience?', a: 'No. We welcome beginners and provide study groups and mentorship.' },
                        { q: 'How do projects work?', a: 'Semester-long teams with mentors; demos at the end of term.' },
                        { q: 'Are events open to all majors?', a: 'Yes! Interdisciplinary participation is our strength.' },
                        { q: 'How do I stay updated?', a: 'Follow our mailing list and social channels; check the Seminars page.' },
                    */}
                    {/*
                    .map((f, i) => (
                        <Grid item xs={12} md={6} key={i}>
                            <Card className="home-card">
                                <CardContent>
                                    <Typography variant="subtitle1" className="home-card-title">{f.q}</Typography>
                                    <Typography variant="body2" className="home-card-desc">{f.a}</Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                    ))}
